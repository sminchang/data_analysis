...
def pdf_table_extract(input_path, output_file):
    ...
    for file_name in os.listdir(input_path):
        ...
        # 최초 초기화는 None으로 초기화, 이후 다중 문건 처리 시 ""으로 초기화
        document_set = {
            # A 테이블
            'accounting_code': None,          # 회계코드
            'accounting_name': None,          # 회계명
            'jurisdiction_code': None,        # 소관코드
            'jurisdiction_name': None,        # 소관명
            'account_code': None,             # 계정코드
            'account_name': None,             # 계정명
            'field_code': None,               # 분야코드
            'field_name': None,               # 분야명
            'sector_code': None,              # 부문코드
            'sector_name': None,              # 부문명
            # B 테이블
            'program_code': None,             # 프로그램코드
            'program_name': None,             # 프로그램명
            'unit_business_code': None,       # 단위사업코드
            'unit_business_name': None,       # 단위사업명
            'detailed_business_code': None,   # 세부사업코드
            'detailed_business_name': None,   # 세부사업명
            # C 테이블
            'N_2': None,                      # N-2년전 결산
            'N_last_1': None,                 # N-1년전 본예산
            'N_last_2': None,                 # N-1년전 추경
            'N_main_1': None,                 # N년 본예산
            'N_main_2': None                  # N년 추경
